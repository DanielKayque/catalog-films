  ...
  return (
    ...
    >
      ...
      {movies.slice(0, 6).map((movie) => (
        ...
        >
          <img
            className="border-2 border-transparent hover:border-2 hover:border-gray-100 transition-all duration-200 rounded-xl h-full shadow-xl shadow-black w-full object-cover lg:object-left-top"
            key={movie.id}
